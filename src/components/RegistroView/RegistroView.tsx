...
type RegistroSection = 'mods' | 'forja' | 'bestiario';

const SECTIONS: { id: RegistroSection; label: string }[] = [
...
export function RegistroView({ character: _character }: RegistroViewProps) {
  const [active, setActive] = useState<RegistroSection>('mods');
...
export function RegistroHeader({ character, onClose, shortcut = 'R' }: RegistroHeaderProps) {
  return (
