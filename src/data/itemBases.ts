...
function rolledDamage(
  ...
  // Dano por golpe = DPS × segundos por ataque — armas lentas batem mais forte.
  const avg = dps * speedSec;
 ...
 *
 * `speedSec` = TEMPO DE ATAQUE em segundos (convenção WoW: quanto demora pra
 * desferir um golpe — maior = mais lento). Adagas ~1.8s · espadas 1h ~2.3–2.6s
 * · maças/machados 1h ~2.6–3.1s · duas mãos ~3.3–3.6s.
 */
function weapon(spec: {
  ...
  const { min, max } = rolledDamage(spec.reqLevel, spec.speedSec, spec.cls);
  return {
    id: spec.id,
    name: spec.name,
    slot: 'arma',
    ...
    baseStats: [
      ...
      { text: `${spec.speedSec.toFixed(1)}s de Tempo de Ataque`, color: 'agilidade', effect: { key: 'weapon-speed', value: spec.speedSec } },
...
export const ITEM_BASES: ItemBase[] = [
  ...
  weapon({ id: 'espada-curta', name: 'Espada Curta', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.3, description: 'Lâmina curta, sem ornamentos. O que se entrega a um aprendiz no primeiro dia.' }),
  weapon({ id: 'espada-longa', name: 'Espada Longa', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 5, description: 'Mais alcance, mais peso. A primeira arma de quem já sobreviveu a uma briga.' }),
  weapon({ id: 'sabre-gasto', name: 'Sabre Gasto', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.5, reqLevel: 11, description: 'Curva leve, gume vivo. Passou por muitas mãos antes da sua.' }),
  weapon({ id: 'espada-larga', name: 'Espada Larga', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 17, description: 'Folha larga que corta fundo. Pesa o suficiente pra abrir armadura leve.' }),
  weapon({ id: 'lamina-de-guerra', name: 'Lâmina de Guerra', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 24, description: 'Feita pra campanha, não pra desfile. Cada entalhe no aço é uma história.' }),
  weapon({ id: 'espada-antiga', name: 'Espada Antiga', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 31, description: 'Forjada num estilo que já não se ensina. O equilíbrio é estranho — e perfeito.' }),
  weapon({ id: 'cimitarra', name: 'Cimitarra', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.5, reqLevel: 38, description: 'Lâmina larga e curva das estepes. Rápida no talho, cruel no retorno.' }),
  weapon({ id: 'espada-nobre', name: 'Espada Nobre', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 45, description: 'Punho trabalhado, aço dobrado dezenas de vezes. Cara de exibir, afiada pra matar.' }),
  weapon({ id: 'lamina-do-crepusculo', name: 'Lâmina do Crepúsculo', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 52, description: 'Escura como a hora entre o dia e a noite. Reflete pouca luz — de propósito.' }),
  weapon({ id: 'espada-corsaria', name: 'Espada Corsária', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.5, reqLevel: 60, description: 'Aço salgado pela maré. Quem a empunhou nunca pediu permissão pra nada.' }),
  weapon({ id: 'gladio-runico', name: 'Gládio Rúnico', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 68, description: 'Runas gravadas no aço pulsam quando o sangue corre. Ninguém lembra a língua delas.' }),
  weapon({ id: 'lamina-eterna', name: 'Lâmina Eterna', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 76, description: 'Não enferruja, não cega, não quebra. Mais velha que o reino que a perdeu.' }),
  weapon({ id: 'espada-abissal', name: 'Espada Abissal', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 84, description: 'Forjada com metal trazido do fundo do mundo. Frio que não passa, por mais que se segure.' }),
  weapon({ id: 'lamina-do-vazio', name: 'Lâmina do Vazio', weaponType: 'espada-uma-mao', cls: '1h', speedSec: 2.5, reqLevel: 92, description: 'O gume parece cortar a própria luz ao redor. Olhar fixo nela dá vertigem.' }),

  // ════════ Espadas de Duas Mãos (níveis escalonados) ════════
  weapon({ id: 'montante-rachado', name: 'Montante Rachado', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.1, description: 'Lâmina grande com uma trinca no aço. Ainda corta — só não confie demais.' }),
  weapon({ id: 'espada-bastarda', name: 'Espada Bastarda', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.1, reqLevel: 8, description: 'Cabo longo pra uma ou duas mãos. Versátil pra quem ainda não decidiu o estilo.' }),
  weapon({ id: 'montante', name: 'Montante', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 15, description: 'Lâmina longa de duas mãos. Precisa de espaço — e de coragem pra erguer.' }),
  weapon({ id: 'espadao-de-ferro', name: 'Espadão de Ferro', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 22, description: 'Ferro bruto e pesado. Não é elegante, mas amassa o que acerta.' }),
  weapon({ id: 'lamina-colossal', name: 'Lâmina Colossal', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 29, description: 'Alta como um homem. Cada golpe é um evento, não um gesto.' }),
  weapon({ id: 'montante-de-guerra', name: 'Montante de Guerra', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 36, description: 'Forjado pra abrir formações inimigas. Balança como um pêndulo de morte.' }),
  weapon({ id: 'espadao-gravado', name: 'Espadão Gravado', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 43, description: 'Versos de batalha gravados na folha inteira. Cada nome é de um morto que ela fez.' }),
  weapon({ id: 'montante-ancestral', name: 'Montante Ancestral', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 50, description: 'Passado de geração em geração até quebrar a linhagem. Pesa o dobro da história.' }),
  weapon({ id: 'lamina-titanica', name: 'Lâmina Titânica', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 57, description: 'Diz-se que foi dimensionada para mãos maiores que as humanas. Acredita-se.' }),
  weapon({ id: 'espadao-abissal', name: 'Espadão Abissal', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 65, description: 'Metal do fundo do mundo, fundido em escala brutal. Esfria a sala ao ser sacado.' }),
  weapon({ id: 'montante-runico', name: 'Montante Rúnico', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 73, description: 'Runas correm pela folha inteira e acendem ao golpe. Pesado de carregar, pior de encarar.' }),
  weapon({ id: 'lamina-do-fim', name: 'Lâmina do Fim', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 81, description: 'Forjada para encerrar coisas que não deveriam terminar de outro jeito.' }),
  weapon({ id: 'espadao-primordial', name: 'Espadão Primordial', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 89, description: 'Anterior ao ferro, anterior aos nomes. Lembra como era cortar antes de haver inimigos.' }),
  weapon({ id: 'montante-da-aniquilacao', name: 'Montante da Aniquilação', weaponType: 'espada-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 97, description: 'O último golpe que muitos verão. Não há defesa que o explique depois.' }),

  // ════════ Machados de Uma Mão (níveis escalonados) ════════
  weapon({ id: 'machadinha', name: 'Machadinha', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, description: 'Lâmina curta de lenhador. Serve pra cortar lenha — e o que mais aparecer.' }),
  weapon({ id: 'machado-de-mao', name: 'Machado de Mão', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 6, description: 'Cabo curto, cabeça pesada. Equilíbrio feito pra uma mão só.' }),
  weapon({ id: 'cutelo', name: 'Cutelo', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 13, description: 'Folha larga de açougueiro. Não distingue carne de osso.' }),
  weapon({ id: 'machado-de-abordagem', name: 'Machado de Abordagem', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 20, description: 'Gancho de um lado, gume do outro. Feito pra subir no convés e descer cabeças.' }),
  weapon({ id: 'machado-largo', name: 'Machado Largo', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 27, description: 'Cabeça ampla que abre talhos largos. Pesa no braço, pesa mais em quem leva.' }),
  weapon({ id: 'machado-de-combate', name: 'Machado de Combate', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 34, description: 'Forjado pra guerra, não pra floresta. Cada entalhe no cabo é uma campanha.' }),
  weapon({ id: 'tomahawk', name: 'Tomahawk', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 41, description: 'Leve e equilibrado. Tão bom de arremessar quanto de empunhar — dizem.' }),
  weapon({ id: 'machado-ornado', name: 'Machado Ornado', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 48, description: 'Gravações cobrem a cabeça inteira. Bonito de ver, terrível de receber.' }),
  weapon({ id: 'machado-espectral', name: 'Machado Espectral', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 55, description: 'O fio parece sumir em certos ângulos. O corte chega antes que você o veja.' }),
  weapon({ id: 'machado-corsario', name: 'Machado Corsário', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 62, description: 'Aço marcado pela maré. Quem o carregou nunca devolveu o que tomou.' }),
  weapon({ id: 'machado-runico', name: 'Machado Rúnico', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 70, description: 'Runas na cabeça do machado esquentam ao primeiro sangue.' }),
  weapon({ id: 'machado-eterno', name: 'Machado Eterno', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 78, description: 'Nunca cega, nunca racha. Já derrubou mais que florestas inteiras.' }),
  weapon({ id: 'machado-abissal', name: 'Machado Abissal', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.8, reqLevel: 86, description: 'Metal do fundo do mundo. Frio o bastante pra queimar a mão descuidada.' }),
  weapon({ id: 'machado-do-vazio', name: 'Machado do Vazio', weaponType: 'machado-uma-mao', cls: '1h', speedSec: 2.6, reqLevel: 94, description: 'A cabeça parece engolir a luz à volta. O golpe abre mais que carne.' }),

  // ════════ Machados de Duas Mãos (níveis escalonados) ════════
  weapon({ id: 'machado-lenhador', name: 'Machado Lenhador', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, description: 'Feito pra derrubar árvores. Funciona igual de bem com qualquer tronco.' }),
  weapon({ id: 'machado-duplo', name: 'Machado Duplo', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.3, reqLevel: 7, description: 'Duas lâminas, uma de cada lado. Nenhum golpe é desperdiçado.' }),
  weapon({ id: 'machado-de-haste', name: 'Machado de Haste', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 14, description: 'Cabeça de machado no topo de uma haste longa. Alcance que a espada não tem.' }),
  weapon({ id: 'machado-de-batalha', name: 'Machado de Batalha', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 21, description: 'Erguido com as duas mãos e toda a fé que sobrar. Desce como sentença.' }),
  weapon({ id: 'cutelo-colossal', name: 'Cutelo Colossal', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 28, description: 'Mais parede que lâmina. O que ele acerta, raramente fica inteiro.' }),
  weapon({ id: 'labrys', name: 'Labrys', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 35, description: 'Machado cerimonial de lâmina dupla. Antigo, sagrado e absolutamente letal.' }),
  weapon({ id: 'machado-do-carrasco', name: 'Machado do Carrasco', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 42, description: 'Um só golpe é todo o trabalho que ele precisa fazer. Nunca um segundo.' }),
  weapon({ id: 'machado-ancestral', name: 'Machado Ancestral', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 49, description: 'Passado entre chefes de guerra até a última linhagem cair. Pesa gerações.' }),
  weapon({ id: 'machado-titanico', name: 'Machado Titânico', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 56, description: 'Dimensionado pra mãos maiores que as humanas. Quem o ergue, ergue com tudo.' }),
  weapon({ id: 'machado-do-abismo', name: 'Machado do Abismo', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 63, description: 'Forjado em escala monstruosa com metal das profundezas. Esfria o ar ao redor.' }),
  weapon({ id: 'grande-machado-runico', name: 'Grande Machado Rúnico', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 71, description: 'Runas correm pela cabeça inteira e acendem ao impacto. Brutal e antigo.' }),
  weapon({ id: 'machado-do-fim', name: 'Machado do Fim', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 79, description: 'Forjado pra terminar o que precisa terminar de uma vez por todas.' }),
  weapon({ id: 'machado-primordial', name: 'Machado Primordial', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.4, reqLevel: 87, description: 'Anterior ao ferro e aos nomes. Lembra como era partir o mundo ao meio.' }),
  weapon({ id: 'machado-da-aniquilacao', name: 'Machado da Aniquilação', weaponType: 'machado-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 95, description: 'Cada golpe é um cataclismo de bolso. Não há armadura que conte a diferença.' }),

  // ════════ Maças de Uma Mão (níveis escalonados) ════════
  // Contundentes: lentas e pesadas — golpes mais fortes pra compensar a cadência.
  weapon({ id: 'clava', name: 'Clava', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, description: 'Um pedaço de madeira pesado numa ponta. Simples como a dor que causa.' }),
  weapon({ id: 'maca-cravejada', name: 'Maça Cravejada', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 4, description: 'Pregos enfiados na cabeça da clava. Bárbaro, mas eficaz.' }),
  weapon({ id: 'marreta-de-pedra', name: 'Marreta de Pedra', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 10, description: 'Cabeça de pedra lascada amarrada ao cabo. Esmaga onde a lâmina escorregaria.' }),
  weapon({ id: 'martelo-de-combate', name: 'Martelo de Combate', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 16, description: 'Cabeça de ferro de um lado, bico do outro. Feito pra amassar elmos.' }),
  weapon({ id: 'maca-flangeada', name: 'Maça Flangeada', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 23, description: 'Aletas de metal concentram o impacto num ponto só. Atravessa placas.' }),
  weapon({ id: 'maca-de-batalha', name: 'Maça de Batalha', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 30, description: 'Equilíbrio feito pra balançar o dia inteiro sem cansar o braço. Quase.' }),
  weapon({ id: 'maca-cerimonial', name: 'Maça Cerimonial', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 37, description: 'Carregada em procissões antes de abrir crânios em batalha. Dupla função.' }),
  weapon({ id: 'maca-lacerante', name: 'Maça Lacerante', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 44, description: 'Farpas curvas que rasgam ao recuar. Não basta acertar — ela quer voltar.' }),
  weapon({ id: 'quebra-rochas', name: 'Quebra-Rochas', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 51, description: 'Pesada o bastante pra rachar pedra. Ossos nem percebem a diferença.' }),
  weapon({ id: 'maca-corsaria', name: 'Maça Corsária', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 59, description: 'Ferro marcado de sal e sangue seco. Sem elegância, só resultado.' }),
  weapon({ id: 'maca-runica', name: 'Maça Rúnica', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 67, description: 'Runas gravadas na cabeça acendem a cada impacto. O troar não é só do metal.' }),
  weapon({ id: 'maca-eterna', name: 'Maça Eterna', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 75, description: 'Nunca amassa, nunca racha. Já reduziu fortalezas a pó, devagar.' }),
  weapon({ id: 'maca-abissal', name: 'Maça Abissal', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 3.1, reqLevel: 83, description: 'Metal do fundo do mundo, denso além do natural. Cada golpe puxa pra baixo.' }),
  weapon({ id: 'maca-do-vazio', name: 'Maça do Vazio', weaponType: 'maca-uma-mao', cls: '1h', speedSec: 2.9, reqLevel: 91, description: 'O impacto parece engolir o som ao redor. O silêncio depois é pior.' }),

  // ════════ Maças de Duas Mãos (níveis escalonados) ════════
  // As mais lentas e demolidoras do arsenal.
  weapon({ id: 'marreta', name: 'Marreta', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, description: 'Uma marreta de trabalho. Não foi feita pra guerra, mas serve muito bem.' }),
  weapon({ id: 'marreta-tribal', name: 'Marreta Tribal', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 6, description: 'Cabeça de pedra entalhada com símbolos de um clã esquecido. Pesa como a tradição.' }),
  weapon({ id: 'malho', name: 'Malho', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 12, description: 'Bloco maciço no fim de um cabo longo. Erguê-lo já é metade da batalha.' }),
  weapon({ id: 'marreta-pesada', name: 'Marreta Pesada', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 19, description: 'Feita pra demolir muros. Faz o mesmo com quem estiver na frente.' }),
  weapon({ id: 'marreta-denteada', name: 'Marreta Denteada', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 26, description: 'Dentes de ferro cobrem a cabeça inteira. Esmaga e rasga no mesmo golpe.' }),
  weapon({ id: 'estrela-da-manha', name: 'Estrela-da-Manhã', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 33, description: 'Esfera espinhada numa haste. Bonita à distância, devastadora de perto.' }),
  weapon({ id: 'marreta-de-guerra', name: 'Marreta de Guerra', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 40, description: 'Forjada só pra destruir. Cada golpe ecoa pelo campo de batalha.' }),
  weapon({ id: 'grande-malho', name: 'Grande Malho', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 47, description: 'Versão de guerra do malho de ferreiro. A bigorna agora é o inimigo.' }),
  weapon({ id: 'marreta-colossal', name: 'Marreta Colossal', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 54, description: 'Mais parede que arma. O que ela acerta deixa de ter forma.' }),
  weapon({ id: 'bate-estacas', name: 'Bate-Estacas', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 62, description: 'Mecanismo que concentra todo o peso na descida. Crava o que toca no chão.' }),
  weapon({ id: 'marreta-runica', name: 'Marreta Rúnica', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 70, description: 'Runas correm pelo cabo e pela cabeça, acesas pela fúria do golpe.' }),
  weapon({ id: 'marreta-do-fim', name: 'Marreta do Fim', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 78, description: 'Erguida uma vez por era, pra encerrar o que não cede de outro jeito.' }),
  weapon({ id: 'marreta-primordial', name: 'Marreta Primordial', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 86, description: 'Anterior às forjas. Lembra como era moldar montanhas a marteladas.' }),
  weapon({ id: 'marreta-da-aniquilacao', name: 'Marreta da Aniquilação', weaponType: 'maca-duas-maos', cls: '2h', speedSec: 3.6, reqLevel: 96, description: 'O peso do fim do mundo num só golpe. Não sobra nada pra identificar.' }),

  // ════════ Adagas (uma mão — níveis escalonados) ════════
  // As mais rápidas do corpo-a-corpo: golpe leve, cadência altíssima.
  weapon({ id: 'estilete', name: 'Estilete', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, description: 'Lâmina fina como agulha. Não corta — perfura, entre as costelas.' }),
  weapon({ id: 'faca-de-caca', name: 'Faca de Caça', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 5, description: 'Feita pra esfolar presa. Funciona igual com caça de duas pernas.' }),
  weapon({ id: 'punhal', name: 'Punhal', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 11, description: 'Curto, oculto, certeiro. A arma de quem prefere não ser visto.' }),
  weapon({ id: 'adaga-serrilhada', name: 'Adaga Serrilhada', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 18, description: 'Dentes no fio que rasgam ao sair. A ferida não fecha sozinha.' }),
  weapon({ id: 'misericordia', name: 'Misericórdia', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 25, description: 'Estreita pra passar pelas frestas da armadura. O golpe de graça.' }),
  weapon({ id: 'punhal-de-ladrao', name: 'Punhal de Ladrão', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 32, description: 'Equilibrado pra sacar rápido e sumir mais rápido ainda.' }),
  weapon({ id: 'adaga-ritual', name: 'Adaga Ritual', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 39, description: 'Usada em ritos que ninguém admite conhecer. O cabo tem manchas antigas.' }),
  weapon({ id: 'lamina-oculta', name: 'Lâmina Oculta', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.0, reqLevel: 46, description: 'Desliza da manga sem aviso. A vítima costuma sorrir até o último instante.' }),
  weapon({ id: 'kris', name: 'Kris', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 53, description: 'Lâmina ondulada que abre feridas largas. Bela e cruel em medidas iguais.' }),
  weapon({ id: 'adaga-corsaria', name: 'Adaga Corsária', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 61, description: 'Curta o bastante pra brigar no aperto de um convés. Resolve rápido.' }),
  weapon({ id: 'adaga-runica', name: 'Adaga Rúnica', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 69, description: 'Runas minúsculas correm pelo fio e acendem ao furar carne.' }),
  weapon({ id: 'adaga-eterna', name: 'Adaga Eterna', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 77, description: 'Nunca cega, nunca enferruja. Já encerrou mais reinados que exércitos.' }),
  weapon({ id: 'adaga-abissal', name: 'Adaga Abissal', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.3, reqLevel: 85, description: 'Metal do fundo do mundo, fino como um suspiro. O frio entra com ela.' }),
  weapon({ id: 'adaga-do-vazio', name: 'Adaga do Vazio', weaponType: 'adaga-uma-mao', cls: '1h', speedSec: 2.1, reqLevel: 93, description: 'O fio some quando você pisca. A ferida aparece antes da lembrança do golpe.' }),

  // ════════ Lanças (uma mão — arma de alcance) ════════
  // Alcance e cadência equilibrada — golpe a distância segura.
  weapon({ id: 'lanca-curta', name: 'Lança Curta', weaponType: 'lanca', cls: '1h', speedSec: 2.5, description: 'Ponta de ferro num cabo curto. Mantém o perigo a um braço de distância.' }),
  weapon({ id: 'azagaia', name: 'Azagaia', weaponType: 'lanca', cls: '1h', speedSec: 2.3, reqLevel: 4, description: 'Leve o bastante pra arremessar, firme o bastante pra empunhar.' }),
  weapon({ id: 'lanca-de-caca', name: 'Lança de Caça', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 10, description: 'Travessa abaixo da ponta pra segurar o que se debate. Útil em mais de uma caça.' }),
  weapon({ id: 'lanca-hoplita', name: 'Lança Hoplita', weaponType: 'lanca', cls: '1h', speedSec: 2.6, reqLevel: 17, description: 'Feita pra muralha de escudos. Sozinha já basta pra manter distância.' }),
  weapon({ id: 'tridente', name: 'Tridente', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 24, description: 'Três pontas que prendem e perfuram. Veio do mar, ficou na guerra.' }),
  weapon({ id: 'lanca-de-batalha', name: 'Lança de Batalha', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 31, description: 'Equilíbrio feito pra estocar o dia inteiro sem soltar o escudo.' }),
  weapon({ id: 'lanca-cerimonial', name: 'Lança Cerimonial', weaponType: 'lanca', cls: '1h', speedSec: 2.6, reqLevel: 38, description: 'Erguida em paradas antes de provar o gume em combate. Faz as duas coisas bem.' }),
  weapon({ id: 'partasana', name: 'Partasana', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 45, description: 'Ponta larga com abas laterais que aparam e cortam. Versátil no aperto.' }),
  weapon({ id: 'lanca-alada', name: 'Lança Alada', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 52, description: 'Asas de metal na base da ponta impedem o golpe de afundar demais. Saca rápido.' }),
  weapon({ id: 'lanca-corsaria', name: 'Lança Corsária', weaponType: 'lanca', cls: '1h', speedSec: 2.3, reqLevel: 60, description: 'Ferro salgado pela maré. Mantém o inimigo longe o bastante pra não revidar.' }),
  weapon({ id: 'lanca-runica', name: 'Lança Rúnica', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 68, description: 'Runas correm pela haste e acendem na ponta a cada estocada.' }),
  weapon({ id: 'lanca-eterna', name: 'Lança Eterna', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 76, description: 'Nunca entorta, nunca cega. Atravessou eras e tudo o que veio na frente.' }),
  weapon({ id: 'lanca-abissal', name: 'Lança Abissal', weaponType: 'lanca', cls: '1h', speedSec: 2.5, reqLevel: 84, description: 'Metal do fundo do mundo numa haste fria. O alcance dela cheira a abismo.' }),
  weapon({ id: 'lanca-do-vazio', name: 'Lança do Vazio', weaponType: 'lanca', cls: '1h', speedSec: 2.3, reqLevel: 92, description: 'A ponta parece sempre um pouco mais longe do que deveria. E chega antes.' }),

  // ════════ Alabardas (duas mãos — polearms de alcance, pesadas e lentas) ════════
  weapon({ id: 'pique', name: 'Pique', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, description: 'Haste longa de ponta simples. Mantém cavalaria e tolos à distância.' }),
  weapon({ id: 'voulge', name: 'Voulge', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 8, description: 'Uma lâmina de cutelo amarrada a uma haste. Rústica, mas decepa bem.' }),
  weapon({ id: 'guisarme', name: 'Guisarme', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 15, description: 'Gancho curvo na ponta da haste. Derruba cavaleiros e prende escudos.' }),
  weapon({ id: 'bardiche', name: 'Bardiche', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 22, description: 'Lâmina longa de machado montada num cabo comprido. Talho amplo e profundo.' }),
  weapon({ id: 'alabarda', name: 'Alabarda', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 29, description: 'Ponta, gancho e lâmina numa haste só. Estoca, puxa e corta — escolha.' }),
  weapon({ id: 'glaive', name: 'Glaive', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 36, description: 'Lâmina longa no topo da haste. Mais talho que estocada, mas alcança igual.' }),
  weapon({ id: 'naginata', name: 'Naginata', weaponType: 'alabarda', cls: '2h', speedSec: 2.9, reqLevel: 43, description: 'Lâmina curva e elegante numa haste longa. Corta o ar em arcos amplos.' }),
  weapon({ id: 'ceifadora', name: 'Ceifadora', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 51, description: 'Uma foice de guerra. Colhe inimigos como quem colhe trigo.' }),
  weapon({ id: 'alabarda-de-guerra', name: 'Alabarda de Guerra', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 59, description: 'Forjada pra abrir formações inteiras. Cada golpe varre uma fileira.' }),
  weapon({ id: 'glaive-colossal', name: 'Glaive Colossal', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 67, description: 'Lâmina do tamanho de um homem na ponta de uma viga. Precisa de espaço — e coragem.' }),
  weapon({ id: 'alabarda-runica', name: 'Alabarda Rúnica', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 75, description: 'Runas correm pela haste e pela lâmina, acesas a cada arco. Brutal e antiga.' }),
  weapon({ id: 'alabarda-abissal', name: 'Alabarda Abissal', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 83, description: 'Metal do fundo do mundo numa haste interminável. O alcance dela cheira a abismo.' }),
  weapon({ id: 'alabarda-primordial', name: 'Alabarda Primordial', weaponType: 'alabarda', cls: '2h', speedSec: 3.1, reqLevel: 91, description: 'Anterior aos exércitos. Lembra como era ceifar antes de haver o que ceifar.' }),
  weapon({ id: 'alabarda-da-aniquilacao', name: 'Alabarda da Aniquilação', weaponType: 'alabarda', cls: '2h', speedSec: 3.3, reqLevel: 98, description: 'Um arco só decide a batalha. O que ela alcança deixa de existir em pé.' }),

  // ════════ Foices (duas mãos — melee ceifante, pesada) ════════
  weapon({ id: 'foice', name: 'Foice', weaponType: 'foice', cls: '2h', speedSec: 3.3, description: 'Uma foice de camponês reaproveitada. Ceifa mais que trigo agora.' }),
  weapon({ id: 'foice-de-guerra', name: 'Foice de Guerra', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 7, description: 'Lâmina curva montada pra matar, não pra colher.' }),
  weapon({ id: 'gadanha', name: 'Gadanha', weaponType: 'foice', cls: '2h', speedSec: 3.4, reqLevel: 14, description: 'Cabo longo, lâmina larga. Um arco de morte a cada golpe.' }),
  weapon({ id: 'foice-de-batalha', name: 'Foice de Batalha', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 21, description: 'Reforçada pra aguentar campanha. Corta fileiras inteiras.' }),
  weapon({ id: 'foice-dupla', name: 'Foice Dupla', weaponType: 'foice', cls: '2h', speedSec: 3.1, reqLevel: 28, description: 'Duas lâminas em pontas opostas. Nenhuma direção é segura.' }),
  weapon({ id: 'foice-ornada', name: 'Foice Ornada', weaponType: 'foice', cls: '2h', speedSec: 3.4, reqLevel: 35, description: 'Gravações cobrem o aço curvo. Bela como a colheita da morte.' }),
  weapon({ id: 'foice-do-ceifador', name: 'Foice do Ceifador', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 44, description: 'A ferramenta clássica de quem colhe almas.' }),
  weapon({ id: 'foice-colossal', name: 'Foice Colossal', weaponType: 'foice', cls: '2h', speedSec: 3.6, reqLevel: 53, description: 'Lâmina do tamanho de um portão. O talho abre caminho no ar.' }),
  weapon({ id: 'foice-runica', name: 'Foice Rúnica', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 62, description: 'Runas correm pela curva da lâmina, acesas a cada ceifa.' }),
  weapon({ id: 'foice-eterna', name: 'Foice Eterna', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 71, description: 'Nunca cega, nunca para. Ceifou eras inteiras.' }),
  weapon({ id: 'foice-espectral', name: 'Foice Espectral', weaponType: 'foice', cls: '2h', speedSec: 3.4, reqLevel: 80, description: 'A lâmina some em névoa e reaparece já do outro lado do corte.' }),
  weapon({ id: 'foice-abissal', name: 'Foice Abissal', weaponType: 'foice', cls: '2h', speedSec: 3.3, reqLevel: 88, description: 'Metal do fundo do mundo curvado em fio. Frio como a morte que traz.' }),
  weapon({ id: 'foice-da-morte', name: 'Foice da Morte', weaponType: 'foice', cls: '2h', speedSec: 3.4, reqLevel: 97, description: 'O instrumento do fim. Um golpe, uma sentença.' }),

  // ════════ Arcos (uma mão — dano à distância) ════════
  weapon({ id: 'arco-curto', name: 'Arco Curto', weaponType: 'arco', cls: '1h', speedSec: 2.6, description: 'Arco simples de madeira. O primeiro passo do caçador.' }),
  weapon({ id: 'arco-longo', name: 'Arco Longo', weaponType: 'arco', cls: '1h', speedSec: 2.8, reqLevel: 5, description: 'Maior alcance, maior tensão. Exige braço firme.' }),
  weapon({ id: 'arco-de-caca', name: 'Arco de Caça', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 11, description: 'Equilibrado pra rastrear e abater à distância.' }),
  weapon({ id: 'arco-composto', name: 'Arco Composto', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 17, description: 'Camadas coladas dão mais potência num arco menor.' }),
  weapon({ id: 'arco-de-guerra', name: 'Arco de Guerra', weaponType: 'arco', cls: '1h', speedSec: 2.8, reqLevel: 24, description: 'Feito pra chuva de flechas em campo aberto.' }),
  weapon({ id: 'arco-recurvo', name: 'Arco Recurvo', weaponType: 'arco', cls: '1h', speedSec: 2.5, reqLevel: 31, description: 'Pontas curvadas ao contrário guardam mais energia. Dispara rápido.' }),
  weapon({ id: 'arco-elfico', name: 'Arco Élfico', weaponType: 'arco', cls: '1h', speedSec: 2.5, reqLevel: 38, description: 'Leve e preciso, feito por mãos que enxergam longe.' }),
  weapon({ id: 'arco-de-osso', name: 'Arco de Osso', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 45, description: 'Ossos temperados no lugar de madeira. Estala baixinho ao tensionar.' }),
  weapon({ id: 'arco-corsario', name: 'Arco Corsário', weaponType: 'arco', cls: '1h', speedSec: 2.5, reqLevel: 52, description: 'Compacto pra atirar de um convés que balança.' }),
  weapon({ id: 'arco-runico', name: 'Arco Rúnico', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 60, description: 'Runas na madeira guiam a flecha ao alvo.' }),
  weapon({ id: 'arco-eterno', name: 'Arco Eterno', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 68, description: 'A corda nunca arrebenta, a madeira nunca racha.' }),
  weapon({ id: 'arco-espectral', name: 'Arco Espectral', weaponType: 'arco', cls: '1h', speedSec: 2.5, reqLevel: 76, description: 'A flecha parece disparar antes de você soltar a corda.' }),
  weapon({ id: 'arco-abissal', name: 'Arco Abissal', weaponType: 'arco', cls: '1h', speedSec: 2.6, reqLevel: 84, description: 'Feito de material das profundezas. As flechas cheiram a abismo.' }),
  weapon({ id: 'arco-do-vazio', name: 'Arco do Vazio', weaponType: 'arco', cls: '1h', speedSec: 2.5, reqLevel: 92, description: 'Tensiona o próprio vazio como corda. O alvo cai antes do som.' }),

  // ════════ Bestas (duas mãos — dano à distância, pesado) ════════
  weapon({ id: 'besta-leve', name: 'Besta Leve', weaponType: 'besta', cls: '2h', speedSec: 3.4, description: 'Mecanismo simples que dispensa força pra mirar. Lenta pra recarregar.' }),
  weapon({ id: 'besta-de-caca', name: 'Besta de Caça', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 8, description: 'Precisa e silenciosa. Abate antes que a presa perceba.' }),
  weapon({ id: 'besta-pesada', name: 'Besta Pesada', weaponType: 'besta', cls: '2h', speedSec: 3.6, reqLevel: 15, description: 'Virote grosso e lento, mas atravessa quase tudo.' }),
  weapon({ id: 'balestra', name: 'Balestra', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 22, description: 'Arco de aço tensionado por manivela. Potência brutal.' }),
  weapon({ id: 'besta-de-guerra', name: 'Besta de Guerra', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 29, description: 'Feita pra perfurar armadura a distância de campo.' }),
  weapon({ id: 'besta-de-repeticao', name: 'Besta de Repetição', weaponType: 'besta', cls: '2h', speedSec: 3.1, reqLevel: 36, description: 'Um carregador de virotes que dispara em sequência.' }),
  weapon({ id: 'besta-ornada', name: 'Besta Ornada', weaponType: 'besta', cls: '2h', speedSec: 3.6, reqLevel: 43, description: 'Gravada e polida. Precisa até nas mãos de um nobre.' }),
  weapon({ id: 'besta-de-assedio', name: 'Besta de Assédio', weaponType: 'besta', cls: '2h', speedSec: 3.6, reqLevel: 50, description: 'Quase uma arma de cerco portátil. O virote derruba portões.' }),
  weapon({ id: 'besta-corsaria', name: 'Besta Corsária', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 57, description: 'Compacta e mortal, feita pra abordagem.' }),
  weapon({ id: 'besta-runica', name: 'Besta Rúnica', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 65, description: 'Runas guiam o virote e reforçam o mecanismo.' }),
  weapon({ id: 'besta-eterna', name: 'Besta Eterna', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 73, description: 'O gatilho nunca falha, a corda nunca cede.' }),
  weapon({ id: 'besta-espectral', name: 'Besta Espectral', weaponType: 'besta', cls: '2h', speedSec: 3.6, reqLevel: 81, description: 'O virote atravessa como se o alvo não estivesse ali — mas está.' }),
  weapon({ id: 'besta-abissal', name: 'Besta Abissal', weaponType: 'besta', cls: '2h', speedSec: 3.4, reqLevel: 89, description: 'Metal das profundezas, virotes gelados. Perfura carne e coragem.' }),
  weapon({ id: 'besta-do-vazio', name: 'Besta do Vazio', weaponType: 'besta', cls: '2h', speedSec: 3.6, reqLevel: 97, description: 'Dispara um vazio afiado. O buraco fica; o alvo, não.' }),
