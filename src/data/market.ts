...
export const INITIAL_MARKET_LISTINGS: MarketListing[] = [
  ...
  equipListing(
    ...
    'ladino',
    {
      ...makeBaseItem('punhal', 'market'),
      id: 'market-m2-punhal',
      rarity: 'raro',
      name: 'Punhal do Lince',
      stats: [
        ...(makeBaseItem('punhal', 'market').stats ?? []),
  ...
  equipListing(
    ...
    'guerreiro',
    {
      ...makeBaseItem('cota-de-malha', 'market'),
      id: 'market-m4-peito',
      rarity: 'magico',
      name: 'Cota de Malha Reforçada',
      stats: [
        ...(makeBaseItem('cota-de-malha', 'market').stats ?? []),
  ...
  equipListing(
    ...
    'ladino',
    {
      ...makeBaseItem('capuz-de-sombras', 'market'),
      id: 'market-m5-capuz',
      rarity: 'comum',
      name: 'Capuz de Sombras',
      stats: makeBaseItem('capuz-de-sombras', 'market').stats,
    },
    18,
    3,
  ),
  equipListing(
    ...
    'guerreiro',
    {
      ...
      stats: [
        ...
        { text: '+14% de Chance de Bloqueio', color: 'fisico', kind: 'prefix', effect: { key: 'pct-bloqueio', value: 14 } },
  ...
  equipListing(
    ...
    'guerreiro',
    {
      ...makeBaseItem('martelo-de-combate', 'market'),
      id: 'market-m11-martelo',
      rarity: 'raro',
      name: 'Martelo de Combate do Vau',
      stats: [
        ...(makeBaseItem('martelo-de-combate', 'market').stats ?? []),
  ...
  equipListing(
    ...
    'mago',
    {
      ...makeBaseItem('amuleto-azul', 'market'),
      id: 'market-m12-amuleto',
      rarity: 'magico',
      name: 'Amuleto Azul Flamejante',
      stats: [
        ...(makeBaseItem('amuleto-azul', 'market').stats ?? []),
